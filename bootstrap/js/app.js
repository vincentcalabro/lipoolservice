...
directory.Router = Backbone.Router.extend({
    ...
    services: function () {
        if (!directory.servicesView) {
            directory.servicesView = new directory.ServicesView();
            directory.servicesView.render();
        }
        this.$content.html(directory.servicesView.el);
        directory.shellView.selectMenuItem('services-menu');
    },
...
$(document).on("ready", function () {
    directory.loadTemplates(["HomeView", "ContactView", "ServicesView", "ShellView", "EmployeeView", "EmployeeSummaryView", "EmployeeListItemView"],
        function () {
